...
import {
  ...
  handleListarPagamentosDoFuncionario,
...
export async function funcionariosRoutes(app: FastifyInstance) {
  ...
  app.get('/:id/pagamentos', { preHandler: [autorizar('GESTOR', 'ENGENHEIRO', 'FUNCIONARIO')], handler: handleListarPagamentosDoFuncionario })
